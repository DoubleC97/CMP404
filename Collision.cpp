...
void Collision::AABBtoAABB(gef::MeshInstance* first_mesh_, gef::MeshInstance* other_mesh_)
{
	...
	left_side2_ = other_mesh_->mesh()->aabb().Transform(other_mesh_transform_matrix).min_vtx().x();
	right_side2_ = other_mesh_->mesh()->aabb().Transform(other_mesh_transform_matrix).max_vtx().x();
	...
	bottom2 = other_mesh_->mesh()->aabb().Transform(other_mesh_transform_matrix).min_vtx().y();
	top2 = other_mesh_->mesh()->aabb().Transform(other_mesh_transform_matrix).max_vtx().y();
	...
	back2_ = other_mesh_->mesh()->aabb().Transform(other_mesh_transform_matrix).min_vtx().z();
	forward2_ = other_mesh_->mesh()->aabb().Transform(other_mesh_transform_matrix).max_vtx().z();
